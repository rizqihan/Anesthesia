...
export const GUIDELINES_DB: GuidelineRecord[] = [
  ...
  },
  {
    "title": {
      "en": "ADHD Management",
      "id": "Penatalaksanaan ADHD / GPPH"
    },
    "category": "Psychiatry",
    "isStructured": true,
    "definition": {
      "en": "Attention-Deficit/Hyperactivity Disorder (ADHD) is a persistent neurodevelopmental disorder characterized by developmentally inappropriate levels of **inattention, hyperactivity, and impulsivity**. Symptoms must be present before **age 12**, occur in **>=2 settings** (e.g., home and school), and significantly interfere with social, academic, or occupational functioning, diagnosed using the **DSM-5-TR criteria**.",
      "id": "Attention-Deficit/Hyperactivity Disorder (ADHD) atau Gangguan Pemusatan Perhatian/Hiperaktivitas (GPPH) adalah gangguan perkembangan saraf persisten yang ditandai dengan tingkat **inadensi, hiperaktivitas, dan impulsivitas** yang tidak sesuai dengan tahap perkembangan. Gejala harus muncul sebelum **usia 12 tahun**, terjadi pada **>=2 lingkungan** (misal: rumah dan sekolah), serta mengganggu fungsi sosial, akademis, atau pekerjaan secara signifikan, didiagnosis menggunakan **kriteria DSM-5-TR**."
    },
    "symptoms": {
      "en": "• **Inattention**: Fails to give close attention to details, makes careless mistakes, has difficulty sustaining attention, does not seem to listen, fails to finish tasks, disorganized, avoids sustained mental effort, loses things, easily distracted, forgetful in daily activities\n• **Hyperactivity & Impulsivity**: Fidgets, taps hands or squirms, leaves seat in situations where remaining seated is expected, runs or climbs inappropriately, unable to play quietly, acts as if 'driven by a motor', talks excessively, blurts out answers before questions are completed, difficulty waiting turn, interrupts or intrudes on others",
      "id": "• **Inatensi**: Gagal memperhatikan detail, membuat kesalahan ceroboh, kesulitan mempertahankan perhatian, tampak tidak mendengarkan, gagal menyelesaikan tugas, tidak terorganisir, menghindari usaha mental yang lama, sering kehilangan barang, mudah teralih, pelupa dalam aktivitas sehari-hari\n• **Hiperaktivitas & Impulsivitas**: Gelisah, mengetuk tangan/kaki atau menggeliat di kursi, meninggalkan tempat duduk ketika seharusnya tenang, berlari/memanjat tidak pada tempatnya, tidak dapat bermain dengan tenang, bertindak seolah 'digerakkan oleh motor', bicara berlebihan, menjawab sebelum pertanyaan selesai, kesulitan menunggu giliran, menyela atau mengganggu orang lain"
    },
    "physicalExamination": {
      "en": "• **Behavioral Observation**: Note physical fidgeting, impulsivity in speech, and direct distractibility during the interview\n• **Cardiovascular Baseline (CRITICAL)**: Measure heart rate and blood pressure prior to initiating stimulant therapy to rule out underlying abnormalities\n• **Anthropometrics**: Monitor height, weight, and growth velocity (stimulants can cause **appetite suppression** and minor growth deceleration in children)",
      "id": "• **Observasi Perilaku**: Catat kegelisahan fisik, impulsivitas bicara, dan kemudahan teralih selama wawancara\n• **Baseline Kardiovaskular (SANGAT KRITIS)**: Ukur denyut nadi dan tekanan darah sebelum memulai terapi stimulan untuk menyingkirkan kelainan mendasar\n• **Antropometri**: Pantau tinggi badan, berat badan, dan kecepatan pertumbuhan (stimulan dapat menyebabkan **supresi nafsu makan** dan sedikit perlambatan pertumbuhan pada anak)"
    },
    "labFindings": {
      "en": "• **Clinical Rating Scales (Gold Standard)**: Utilize standardized scales for diagnosis and monitoring:\n  • Children: **Vanderbilt Assessment Scales** or Conners Rating Scales (completed by parents and teachers)\n  • Adults: **Adult ADHD Self-Report Scale (ASRS v1.1)**\n• **Laboratory Workup**: Check CBC, thyroid panel (TSH/free T4 to rule out hyperthyroidism), and serum lead levels in children if exposed\n• **ECG**: Baseline electrocardiogram is recommended if there is a personal history of cardiac disease, palpitations, syncope, or a family history of sudden cardiac death at <40 years",
      "id": "• **Skala Penilaian Klinis (Gold Standard)**: Gunakan skala terstandardisasi untuk diagnosis dan pemantauan:\n  • Anak-anak: **Vanderbilt Assessment Scales** atau Conners Rating Scales (diisi oleh orang tua dan guru)\n  • Dewasa: **Adult ADHD Self-Report Scale (ASRS v1.1)**\n• **Pemeriksaan Laboratorium**: Periksa Darah Lengkap, panel tiroid (TSH/T4 bebas untuk singkirkan hipertiroidisme), dan kadar timbal serum pada anak jika ada paparan\n• **EKG**: Elektrokardiogram baseline direkomendasikan jika ada riwayat pribadi penyakit jantung, palpitasi, sinkop, atau riwayat keluarga mati mendadak pada usia <40 tahun"
    },
    "differentialDiagnosis": {
      "en": "• Specific Learning Disabilities\n• Autism Spectrum Disorder (ASD)\n• Pediatric Anxiety or Major Depressive Disorder\n• Hyperthyroidism\n• Sleep-Disordered Breathing / Obstructive Sleep Apnea (causes daytime inattention and hyperactivity in children)\n• Childhood Trauma / PTSD",
      "id": "• Kesulitan Belajar Spesifik (Learning Disabilities)\n• Gangguan Spektrum Autisme (ASD)\n• Gangguan Kecemasan atau Depresi Mayor pada Anak\n• Hipertiroidisme\n• Gangguan Napas Saat Tidur / Sleep Apnea Obstruktif (menyebabkan inatensi dan hiperaktivitas siang hari pada anak)\n• Trauma Masa Kecil / PTSD"
    },
    "dangerSigns": {
      "en": "• **Suicidal Ideation / Self-Harm**: Marked increase in self-harm risk (highly correlated with comorbid Oppositional Defiant Disorder, Conduct Disorder, or Depression)\n• **Stimulant Toxicity**: Severe hypertension, tachycardia, chest pain, palpitations, or cardiac arrhythmias\n• **Treatment-Induced Psychosis/Mania**: Development of hallucinations, paranoia, or manic symptoms during stimulant therapy\n• **Severe Appetite Suppression**: Significant weight loss (>10% body weight) or failure to grow along height/weight percentiles in children",
      "id": "• **Ide Bunuh Diri / Melukai Diri**: Peningkatan nyata risiko melukai diri sendiri (sangat berkorelasi dengan komorbiditas Gangguan Pembangkang Oposisional, Gangguan Perilaku, atau Depresi)\n• **Toksisitas Stimulan**: Hipertensi berat, takikardia, nyeri dada, palpitasi, atau aritmia jantung\n• **Psikosis/Mania Akibat Terapi**: Munculnya halusinasi, paranoia, atau gejala mania selama terapi stimulan\n• **Supresi Nafsu Makan Berat**: Penurunan berat badan yang signifikan (>10% berat badan) atau kegagalan pertumbuhan tinggi/berat badan pada anak"
    },
    "management": {
      "initialTreatment": {
        "en": "• **Preschool Children (Ages 4-5)**: Parent training in behavior management (PTBM) and/or classroom behavioral interventions are first-line. Avoid pharmacotherapy unless severe\n• **Psychoeducation**: Educate parents and teachers on positive reinforcement, structured daily routines, and school accommodations (IEP or 504 plans)\n• **Baseline Screening**: Complete a comprehensive cardiovascular history and physical prior to starting medications",
        "id": "• **Anak Prasekolah (Usia 4-5 Tahun)**: Pelatihan orang tua dalam manajemen perilaku (PTBM) yang berbasis bukti dan/atau intervensi perilaku kelas adalah lini pertama. Hindari farmakoterapi kecuali sangat berat\n• **Psikoedukasi**: Edukasi orang tua dan guru mengenai penguatan positif (positive reinforcement), rutinitas harian terstruktur, dan akomodasi sekolah\n• **Skrining Baseline**: Lengkapi riwayat kardiovaskular komprehensif dan pemeriksaan fisik sebelum memulai pengobatan"
      },
      "definitiveTreatment": {
        "en": "• **Pharmacotherapy (First-line for school-aged children >=6 years and adults)**:\n  • **First-Line Stimulants (Methylphenidate)**: Start **Methylphenidate IR 5 mg PO daily or bid** (titrate weekly up to 20-30 mg/day) OR **Methylphenidate Extended-Release (ER) 18 mg PO daily** (titrate up to 54-72 mg/day). Stimulants block dopamine and norepinephrine reuptake\n  • **Second-Line Non-Stimulants (Atomoxetine)**: Start **Atomoxetine 40 mg PO daily** (titrate after 3 days to target **80 mg PO daily**). Indicated for patients with active substance abuse history, severe anxiety, comorbid tics, or stimulant intolerance\n  • **Alpha-2 Adrenergic Agonists**: **Clonidine ER 0.1 mg PO daily** or **Guanfacine ER 1 mg PO daily** (useful as adjunctive therapy or for comorbid sleep/tic disorders)",
        "id": "• **Farmakoterapi (Lini pertama untuk anak usia sekolah >=6 tahun dan dewasa)**:\n  • **Stimulan Lini Pertama (Metilfenidat)**: Mulai **Metilfenidat IR 5 mg PO sehari atau 2x sehari** (titrasi mingguan hingga 20-30 mg/hari) ATAU **Metilfenidat Extended-Release (ER) 18 mg PO sehari** (titrasi hingga 54-72 mg/hari). Stimulan menghambat reuptake dopamin dan norepinefrin\n  • **Non-Stimulan Lini Kedua (Atomoxetine)**: Mulai **Atomoxetine 40 mg PO sehari** (titrasi setelah 3 hari ke target **80 mg PO sehari**). Diindikasikan untuk pasien dengan riwayat penyalahgunaan zat aktif, kecemasan berat, komorbiditas tik, atau intoleransi stimulan\n  • **Agonis Adrenergi Alfa-2**: **Klonidin ER 0.1 mg PO sehari** atau **Guanfasin ER 1 mg PO sehari** (berguna sebagai terapi tambahan atau komorbiditas gangguan tidur/tik)"
      },
      "rehab": {
        "en": "• Cognitive Behavioral Therapy (CBT) focused on executive functioning, time management, and organizational skills (highly effective in adults)\n• Parent-Child Interaction Therapy (PCIT) to restore positive family dynamics",
        "id": "• Terapi Perilaku Kognitif (CBT) yang berfokus pada fungsi eksekutif, manajemen waktu, dan keterampilan organisasi (sangat efektif pada dewasa)\n• Parent-Child Interaction Therapy (PCIT) untuk memulihkan dinamika keluarga yang positif"
      },
      "referral": {
        "en": "• **Refer to Child & Adolescent / Adult Psychiatry** for:\n  • Diagnostic uncertainty or complex comorbid conditions (Bipolar, Conduct Disorder, Active Substance Abuse)\n  • Treatment-resistant ADHD failing trials of both methylphenidate and atomoxetine\n  • Development of severe adverse drug events (arrhythmias, psychosis, suicidal ideation)\n• **Refer to Pediatric Cardiology** if significant baseline ECG abnormalities are found",
        "id": "• **Rujuk ke Spesialis Kedokteran Jiwa (Psikiater Anak/Dewasa)** untuk:\n  • Ketidakpastian diagnosis atau kondisi komorbiditas yang kompleks (Bipolar, Gangguan Perilaku, Penyalahgunaan Zat Aktif)\n  • ADHD yang resisten terhadap pengobatan (gagal dalam uji coba metilfenidat dan atomoxetine)\n  • Munculnya efek samping obat yang parah (aritmia, psikosis, ide bunuh diri)\n• **Rujuk ke Kardiologi Anak** jika ditemukan kelainan EKG baseline yang signifikan"
      },
      "workup": {
        "en": "• Complete clinical interviews, compile standardized rating scales (parent/teacher/self), screen for medical and psychiatric comorbidities, assess baseline cardiovascular status, and outline treatment goals",
        "id": "• Lengkapi wawancara klinis, kumpulkan skala penilaian standar (orang tua/guru/mandiri), skrining komorbiditas medis dan psikiatri, nilai status kardiovaskular baseline, dan tentukan target pengobatan"
      }
    },
    "followUp": {
      "en": "• Follow up every **1-4 weeks** during medication titration to assess efficacy and side effects (insomnia, appetite loss, headache, irritability)\n• Once stable, follow up every **3-6 months** to monitor height/weight percentiles, blood pressure, heart rate, and academic/functional performance",
      "id": "• Tindak lanjut setiap **1-4 minggu** selama titrasi obat untuk menilai efektivitas dan efek samping (insomnia, nafsu makan menurun, sakit kepala, iritabilitas)\n• Setelah stabil, kontrol setiap **3-6 bulan** untuk memantau persentil tinggi/berat badan, tekanan darah, denyut nadi, serta performa akademis/fungsional"
    },
    "prevention": {
      "pharmacological": {
        "en": "• Avoid preemptive pharmacotherapy; focus on high-quality behavioral interventions and parenting training during early childhood to limit functional impairment",
        "id": "• Hindari farmakoterapi preventif; fokus pada intervensi perilaku berkualitas tinggi dan pelatihan orang tua selama masa anak-anak awal untuk membatasi gangguan fungsional"
      },
      "nonPharmacological": {
        "en": "• Establish highly structured, predictable daily routines and clear household rules\n• Minimize screen time and promote regular sleep hygiene and active play\n• Limit high-sugar dietary items if parent reports direct behavioural exacerbation",
        "id": "• Tetapkan rutinitas harian yang sangat terstruktur, mudah diprediksi, dan aturan rumah tangga yang jelas\n• Minimalkan waktu menatap layar (screen time) dan dorong kebersihan tidur yang teratur serta permainan aktif\n• Batasi makanan tinggi gula jika orang tua melaporkan eksaserbasi perilaku langsung"
      }
    },
    "caseExample": {
      "en": "A 9-year-old male is referred by his teacher due to academic failure, constant daydreaming, leaving his seat, and interrupting classmates. His parents note extreme difficulty completing homework and a disorganized room. The **Vanderbilt Scale** completed by both parent and teacher reveals 7 inattention symptoms and 6 hyperactive symptoms, meeting DSM-5 criteria for ADHD (Combined Type). Baseline heart rate (82 bpm) and blood pressure (102/64 mmHg) are normal, with no cardiovascular family history. He is started on **Methylphenidate ER 18 mg PO daily** and his parents attend a behavioral training program. At 4 weeks, the teacher reports significant focus improvements, finished schoolwork, and stable behavior. His vitals remain stable, and a slight initial appetite loss resolves by taking the medication immediately after a hearty breakfast.",
      "id": "Seorang anak laki-laki berusia 9 tahun dirujuk oleh gurunya karena kegagalan akademis, sering melamun, sering meninggalkan tempat duduk, dan menyela teman sekelasnya. Orang tuanya mencatat kesulitan ekstrem dalam menyelesaikan PR dan kamar yang tidak teratur. **Vanderbilt Scale** yang diisi oleh orang tua dan guru menunjukkan 7 gejala inatensi dan 6 gejala hiperaktif, memenuhi kriteria DSM-5 untuk ADHD (Tipe Kombinasi). Denyut nadi baseline (82 x/menit) dan tekanan darah (102/64 mmHg) normal, tanpa riwayat keluarga penyakit jantung. Ia mulai diberikan **Metilfenidat ER 18 mg PO sehari** dan orang tuanya mengikuti program pelatihan perilaku. Pada 4 minggu, guru melaporkan peningkatan fokus yang signifikan, tugas sekolah selesai, dan perilaku stabil. Tanda-tanda vitalnya tetap stabil, dan sedikit penurunan nafsu makan di awal teratasi dengan meminum obat segera setelah sarapan porsi besar."
    },
    "references": {
      "en": "• AAP Clinical Practice Guideline for the Diagnosis, Evaluation, and Treatment of Attention-Deficit/Hyperactivity Disorder in Children and Adolescents (Pediatrics 2019)\n• AACAP Practice Parameter for the Assessment and Treatment of Children and Adolescents with Attention-Deficit/Hyperactivity Disorder (JAACAP 2007)\n• Wolraich ML, et al. Pediatrics. 2019;144(4):e20192528",
      "id": "• Pedoman Praktik Klinis AAP untuk Diagnosis, Evaluasi, dan Pengobatan Gangguan Pemusatan Perhatian/Hiperaktivitas pada Anak dan Remaja (Pediatrics 2019)\n• Parameter Praktik AACAP untuk Penilaian dan Pengobatan Anak dan Remaja dengan Gangguan Pemusatan Perhatian/Hiperaktivitas (JAACAP 2007)\n• Wolraich ML, et al. Pediatrics. 2019;144(4):e20192528"
    },
    "id": 32,
    "content": {
      "en": "Attention-Deficit/Hyperactivity Disorder (ADHD) is a persistent neurodevelopmental disorder characterized by developmentally inappropriate levels of **inattention, hyperactivity, and impulsivity**. Symptoms must be present before **age 12**, occur in **>=2 settings** (e.g., home and school), and significantly interfere with social, academic, or occupational functioning, diagnosed using the **DSM-5-TR criteria**.",
  ...
  {
    "title": {
      "en": "Acute Psychotic Disorder",
      "id": "Gangguan Psikotik Akut"
    },
    "category": "Psychiatry",
    "isStructured": true,
    "definition": {
      "en": "Acute Psychotic Disorder (classified as Brief Psychotic Disorder in the DSM-5-TR) is characterized by the sudden onset of **>=1 positive psychotic symptom** (delusions, hallucinations, disorganized speech, or grossly disorganized/catatonic behavior), lasting **from 1 day to <1 month**, with an eventual full return to the premorbid level of functioning. It is often precipitated by an acute severe life stressor.",
      "id": "Gangguan Psikotik Akut (diklasifikasikan sebagai Gangguan Psikotik Singkat dalam DSM-5-TR) ditandai dengan onset mendadak dari **>=1 gejala psikotik positif** (waham/delusi, halusinasi, pembicaraan kacau, atau perilaku sangat kacau/katatonik), berlangsung selama **1 hari hingga <1 bulan**, dengan kembali penuh ke tingkat fungsi premorbid. Kondisi ini sering dipicu oleh stresor hidup akut yang berat."
    },
    "symptoms": {
      "en": "• **Delusions**: Strongly held false beliefs refractory to logical counterarguments (e.g., persecutory/paranoid, grandiose, somatic, or referential delusions)\n• **Hallucinations**: Perception-like experiences occurring without an external stimulus (most commonly auditory, but can be visual, olfactory, or tactile)\n• **Disorganized Speech**: Incoherence, rapid derailment, loose associations, or word salad\n• **Grossly Disorganized Behavior**: Severe psychomotor agitation, bizarre unprovoked actions, dressing in an inappropriate manner\n• **Catatonic Symptoms**: Stupor, mutism, waxy flexibility, negativism, or posturing",
      "id": "• **Waham / Delusi**: Keyakinan salah yang dipegang teguh dan tidak dapat diubah dengan argumen logis (misal: waham kejar/paranoik, kebesaran, somatik, atau rujukan)\n• **Halusinasi**: Pengalaman sensorik seperti persepsi nyata yang terjadi tanpa stimulus eksternal (paling sering berupa suara/auditorik, tetapi bisa juga visual, pembauan, atau rabaan/taktil)\n• **Bicara Kacau**: Inkoherensi, pelanturan cepat (derailment), asosiasi longgar, atau gado-gado kata (word salad)\n• **Perilaku Sangat Kacau**: Agitasi psikomotor berat, tindakan aneh tanpa provokasi, berpakaian sangat tidak sesuai\n• **Gejala Katatonia**: Stupor, mutisme, fleksibilitas lilin (waxy flexibility), negativisme, atau posturing"
    },
    "physicalExamination": {
      "en": "• **Mental Status Examination (MSE)**: Assess appearance (neglected hygiene, bizarre dress), psychomotor activity (agitated or stuporous), speech (pressured, slow, or incoherent), thought process (tangential, circular), and thought content (hallucinations, active suicidal/homicidal ideation)\n• **Neurological Exam**: Evaluate for focal deficits, meningeal signs (rigidity), or pupillary abnormalities to rule out organic causes (e.g., encephalitis, brain tumor)\n• **Vital Signs Monitoring**: Closely monitor for hyperthermia, tachycardia, and severe rigidity, which are key diagnostic indicators for **Neuroleptic Malignant Syndrome (NMS)**",
      "id": "• **Pemeriksaan Status Mental (MSE)**: Nilai penampilan (kebersihan diri terabaikan, pakaian aneh), aktivitas psikomotor (agitasi atau stupor), bicara (cepat/tertekan, lambat, atau inkoheren), proses pikir (tangensial, melingkar), dan isi pikir (halusinasi, ide bunuh diri/membunuh aktif)\n• **Pemeriksaan Neurologis**: Evaluasi defisit fokal, tanda rangsang meningeal (kaku kuduk), atau kelainan pupil untuk menyingkirkan penyebab organik (misal: ensefalitis, tumor otak)\n• **Pemantauan Tanda Vital**: Pantau ketat adanya hipertermia, takikardia, dan rigiditas berat, yang merupakan indikator diagnostik utama **Sindrom Neuroleptik Maligna (SNM)**"
    },
    "labFindings": {
      "en": "• **Organic Psychosis Screen (MANDATORY)**: \n  • **Urine Drug Screen (UDS)**: Rule out substance-induced psychosis (Amphetamines, Cannabis, Cocaine, Phencyclidine)\n  • Complete Blood Count, electrolytes, renal and liver function panels\n  • Thyroid panel (TSH) to rule out severe thyrotoxicosis or myxedema madness\n  • Neurosyphilis screen (VDRL/RPR) and HIV testing\n• **Neuroimaging**: Brain CT or MRI is indicated for first-episode psychosis, new-onset focal neurological signs, or altered consciousness\n• **Lumbar Puncture**: Indicated if fever, altered consciousness, and signs of meningitis/encephalitis are present (rule out autoimmune or infectious encephalitis)",
      "id": "• **Skrining Psikosis Organik (WAJIB)**:\n  • **Urine Drug Screen (UDS)**: Singkirkan psikosis akibat zat (Amfetamin, Ganja, Kokain, Fensiklidin)\n  • Darah Lengkap, elektrolit, panel fungsi ginjal dan hati\n  • Panel tiroid (TSH) untuk menyingkirkan tirotoksikosis berat atau miksedema\n  • Skrining neurosifilis (VDRL/RPR) dan tes HIV\n• **Pencitraan Saraf**: CT scan atau MRI otak diindikasikan untuk psikosis episode pertama, tanda neurologis fokal baru, atau penurunan kesadaran\n• **Pungsi Lumbal**: Diindikasikan jika ada demam, penurunan kesadaran, dan tanda meningitis/ensefalitis (singkirkan ensefalitis autoimun atau infeksi)"
    },
    "differentialDiagnosis": {
      "en": "• Schizophrenia or Schizophreniform Disorder (longer duration: >6 months and 1-6 months respectively)\n• Substance-Induced Psychotic Disorder\n• Psychosis Secondary to a General Medical Condition (e.g., Systemic Lupus Erythematosus (SLE), brain tumors, stroke)\n• Bipolar Disorder (manic episode with psychotic features)\n• Major Depressive Disorder with Psychotic Features",
      "id": "• Skizofrenia atau Gangguan Skizofreniform (durasi lebih lama: masing-masing >6 bulan dan 1-6 bulan)\n• Gangguan Psikotik Akibat Zat\n• Psikosis Sekunder Akibat Kondisi Medis Umum (misal: Lupus Eritematosus Sistemik (LES), tumor otak, stroke)\n• Gangguan Bipolar (episode manik dengan fitur psikotik)\n• Gangguan Depresi Mayor dengan Fitur Psikotik"
    },
    "dangerSigns": {
      "en": "• **Active Suicide Risk**: Strong impulses or plans to commit suicide\n• **Aggressive / Violent Behavior**: Immediate danger to family members, staff, or others\n• **Command Hallucinations**: Auditory voices commanding the patient to harm themselves or others\n• **Severe Catatonia**: Extreme stupor or mutism leading to complete refusal of food and fluids (risk of dehydration and acute renal failure)\n• **Neuroleptic Malignant Syndrome (NMS)**: Triad of severe muscular 'lead-pipe' rigidity, high fever (hyperthermia), and autonomic instability (tachycardia, fluctuating blood pressure)",
      "id": "• **Risiko Bunuh Diri Aktif**: Dorongan kuat atau rencana untuk melakukan buang air besar\n• **Perilaku Agresif / Kekerasan**: Bahaya langsung bagi anggota keluarga, staf medis, atau orang lain\n• **Halusinasi Komando**: Suara-suara pendengaran yang memerintahkan pasien untuk melukai diri sendiri atau orang lain\n• **Katatonia Berat**: Stupor ekstrem atau mutisme yang menyebabkan penolakan total terhadap makanan dan cairan (risiko dehidrasi dan gagal ginjal akut)\n• **Sindrom Neuroleptik Maligna (SNM)**: Trias dari rigiditas otot 'lead-pipe' yang parah, demam tinggi (hipertermia), dan instabilitas otonom (takikardia, tekanan darah berfluktuasi)"
    },
    "management": {
      "initialTreatment": {
        "en": "• **Ensure Safety**: Place the patient in a quiet, low-stimulation environment under continuous 1-on-1 observation. Remove dangerous objects\n• **Verbal De-escalation**: Attempt calm verbal techniques to reassure the patient and establish rapport\n• **Rapid Tranquilization (ED Agitation Management)**: If the patient is severely agitated or threatening violence:\n  • Administer **Haloperidol 5 mg IM** paired with **Lorazepam 2 mg IM** OR **Diazepam 5-10 mg IV/IM**\n  • Monitor vitals, respiratory status, and extrapyramidal side effects continuously",
        "id": "• **Pastikan Keselamatan**: Tempatkan pasien di lingkungan yang tenang, stimulasi rendah, di bawah observasi terus-menerus 1-lawan-1. Singkirkan benda-benda berbahaya\n• **De-eskalasi Verbal**: Upayakan teknik verbal yang tenang untuk menenangkan pasien dan membangun hubungan saling percaya\n• **Tranquilization Cepat (Penanganan Agitasi IGD)**: Jika pasien sangat teragitasi atau mengancam kekerasan:\n  • Berikan **Haloperidol 5 mg IM** dipadukan dengan **Lorazepam 2 mg IM** ATAU **Diazepam 5-10 mg IV/IM**\n  • Pantau tanda vital, status pernapasan, dan efek samping ekstrapyramidal secara terus-menerus"
      },
      "definitiveTreatment": {
        "en": "• **Atypical Antipsychotics (First-Line)**: Preferred over typical agents due to lower risk of extrapyramidal symptoms (EPS):\n  • Start **Risperidone 1-2 mg PO bid** (titrate to maximum 6 mg/day) OR **Olanzapine 5-10 mg PO daily** (titrate to max 20 mg/day) OR **Aripiprazole 10-15 mg PO daily** (titrate to max 30 mg/day)\n  • Continue pharmacotherapy for at least **6 months** after full symptom resolution to prevent relapse, followed by a very gradual taper\n• **Psychotherapy**: Meticulous supportive psychotherapy and family education to decrease stress and Lower Expressed Emotion (EE) in the home environment",
        "id": "• **Antipsikotik Atipikal (Lini Pertama)**: Lebih disukai daripada agen tipikal karena risiko gejala ekstrapyramidal (EPS) yang lebih rendah:\n  • Mulai **Risperidon 1-2 mg PO 2x sehari** (titrasi hingga maksimal 6 mg/hari) ATAU **Olanzapin 5-10 mg PO sehari** (titrasi hingga maks 20 mg/hari) ATAU **Aripiprazol 10-15 mg PO sehari** (titrasi hingga maks 30 mg/hari)\n  • Lanjutkan farmakoterapi selama minimal **6 bulan** setelah resolusi gejala lengkap untuk mencegah kekambuhan, diikuti dengan penurunan dosis (tapering) yang sangat bertahap\n• **Psikoterapi**: Psikoterapi suportif yang teliti dan edukasi keluarga untuk mengurangi stres serta menurunkan Expressed Emotion (EE) di lingkungan rumah"
      },
      "rehab": {
        "en": "• Social skills rehabilitation and gradual reintegration into work or study activities\n• Cognitive coping strategies to identify early warning triggers of relapse",
        "id": "• Rehabilitasi keterampilan sosial dan reintegrasi bertahap ke dalam aktivitas kerja atau belajar\n• Strategi koping kognitif untuk mengidentifikasi pemicu peringatan dini kekambuhan"
      },
      "referral": {
        "en": "• **Refer for Urgent Psychiatric Admission / Psychiatric ED** if:\n  • High suicide risk, severe self-neglect, or catatonic symptoms\n  • High risk of violence, aggression, or failure of outpatient safety containment\n  • Signs of neuroleptic malignant syndrome (NMS) or severe medication cardiotoxicity",
        "id": "• **Rujuk untuk Rawat Inap Psikiatri Segera / IGD Psikiatri** jika:\n  • Risiko bunuh diri tinggi, penelantaran diri yang parah, atau gejala katatonik\n  • Risiko tinggi kekerasan, agresivitas, atau kegagalan penanganan keselamatan rawat jalan\n  • Tanda-tanda sindrom neuroleptik maligna (SNM) atau toksisitas jantung obat yang parah"
      },
      "workup": {
        "en": "• Perform physical and neurological examinations, conduct MSE, obtain mandatory UDS, check basic lab panel, and monitor metabolic baseline (weight, blood pressure, fasting lipids/glucose before starting atypical antipsychotics)",
        "id": "• Lakukan pemeriksaan fisik dan neurologis, lakukan MSE, dapatkan UDS wajib, periksa panel lab dasar, dan pantau baseline metabolik (berat badan, tekanan darah, profil lipid/glukosa puasa sebelum memulai antipsikotik atipikal)"
      }
    },
    "followUp": {
      "en": "• Follow up weekly post-discharge to evaluate symptom control and screen for **extrapyramidal symptoms (EPS)** using the **AIMS Scale** (monitor for acute dystonia, akathisia, or parkinsonism)\n• Monitor metabolic parameters (weight, glucose, lipid panel) at 12 weeks, and then annually",
      "id": "• Tindak lanjut mingguan pasca-pemulangan untuk mengevaluasi kontrol gejala dan menskrining **gejala ekstrapyramidal (EPS)** menggunakan **AIMS Scale** (pantau distonia akut, akatisia, atau parkinsonisme)\n• Pantau parameter metabolik (berat badan, glukosa, profil lipid) pada minggu ke-12, dan kemudian setiap tahun"
    },
    "prevention": {
      "pharmacological": {
        "en": "• Strict compliance with the 6-month post-remission maintenance therapy is the single most effective factor in preventing relapse",
        "id": "• Kepatuhan ketat terhadap terapi pemeliharaan selama 6 bulan pasca-remisi adalah faktor tunggal paling efektif dalam mencegah kekambuhan"
      },
      "nonPharmacological": {
        "en": "• Stress reduction protocols, counseling on avoiding **Cannabis, Amphetamines**, or other recreational drugs which strongly precipitate psychotic episodes",
        "id": "• Protokol pengurangan stres, konseling untuk menghindari **Ganja, Amfetamin**, atau obat rekreasi lainnya yang sangat memicu episode psikotik"
      }
    },
    "caseExample": {
      "en": "A 24-year-old female presents with a sudden onset of bizarre paranoid delusions, stating that her neighbors are spying on her via satellites, accompanied by auditory hallucinations of whispering voices. Symptoms started 3 days ago following a major career loss; she was previously high-functioning with no psychiatric history. In the ED, she is highly anxious but cooperative. Urine drug screen is negative, TSH and electrolytes are normal. She is diagnosed with Acute Psychotic Disorder (Brief Psychotic Disorder with marked stressors) and started on **Olanzapine 10 mg PO daily** and supportive counseling. Within 10 days, her delusions and hallucinations completely resolve. She continues the medication for 6 months with zero side effects, gradually tapers off, and returns fully to her baseline career activities.",
      "id": "Seorang wanita 24 tahun datang dengan onset mendadak dari waham kejar/paranoik yang aneh, menyatakan bahwa tetangganya memata-matainya melalui satelit, disertai halusinasi pendengaran berupa suara berbisik. Gejala dimulai 3 hari lalu setelah kegagalan karier yang besar; sebelumnya ia berfungsi sangat baik tanpa riwayat psikiatri. Di IGD, ia sangat cemas tetapi kooperatif. Skrining obat urin negatif, TSH dan elektrolit normal. Ia didiagnosis dengan Gangguan Psikotik Akut (Gangguan Psikotik Singkat dengan stresor nyata) dan mulai diberikan **Olanzapin 10 mg PO sehari** dan konseling suportif. Dalam 10 hari, waham dan halusinasinya sepenuhnya hilang. Ia melanjutkan pengobatan selama 6 bulan tanpa efek samping sama sekali, menurunkan dosis secara bertahap, dan kembali sepenuhnya ke aktivitas karier baselinenya."
    },
    "references": {
      "en": "• APA Practice Guideline for the Treatment of Patients with Schizophrenia, 3rd Edition (American Psychiatric Association 2020)\n• World Health Organization ICD-11 Guidelines for Acute and Transient Psychotic Disorders\n• Keepers GA, et al. Am J Psychiatry. 2020;177(9):868-872",
      "id": "• Pedoman Praktik APA untuk Pengobatan Pasien dengan Skizofrenia, Edisi ke-3 (American Psychiatric Association 2020)\n• Pedoman WHO ICD-11 untuk Gangguan Psikotik Akut dan Transien\n• Keepers GA, et al. Am J Psychiatry. 2020;177(9):868-872"
    },
    "id": 33,
    "content": {
      "en": "Acute Psychotic Disorder (Brief Psychotic Disorder in the DSM-5-TR) is characterized by the sudden onset of **>=1 positive psychotic symptom** (delusions, hallucinations, disorganized speech, or grossly disorganized/catatonic behavior), lasting **from 1 day to <1 month**, with an eventual full return to the premorbid level of functioning. It is often precipitated by an acute severe life stressor.",
      "id": "Gangguan Psikotik Akut (diklasifikasikan sebagai Gangguan Psikotik Singkat dalam DSM-5-TR) ditandai dengan onset mendadak dari **>=1 gejala psikotik positif** (waham/delusi, halusinasi, pembicaraan kacau, atau perilaku sangat kacau/katatonik), berlangsung selama **1 hari hingga <1 bulan**, dengan kembali penuh ke tingkat fungsi premorbid. Kondisi ini sering dipicu oleh stresor hidup akut yang berat."
    }
  },
  {
    "title": {
      "en": "Depression Management",
      "id": "Penatalaksanaan Depresi"
    },
    "category": "Psychiatry",
    "isStructured": true,
    "definition": {
      "en": "Major Depressive Disorder (MDD) is a common, highly disabling psychiatric disorder characterized by **>=2 weeks** of persistent **depressed mood** or **anhedonia** (loss of interest or pleasure), accompanied by at least 4 additional somatic or cognitive symptoms (changes in sleep, appetite, energy, self-valuation, psychomotor activity, concentration, or suicidal thoughts), diagnosed using the **DSM-5-TR criteria**.",
      "id": "Gangguan Depresi Mayor (MDD) adalah gangguan psikiatri yang umum dan melumpuhkan, ditandai oleh perasaan **depresi** yang menetap atau **anhedonia** (kehilangan minat atau kesenangan) selama **>=2 minggu**, disertai dengan setidaknya 4 gejala somatik atau kognitif tambahan (perubahan tidur, nafsu makan, energi, penilaian diri, aktivitas psikomotor, konsentrasi, atau pikiran buung diri), didiagnosis menggunakan **kriteria DSM-5-TR**."
    },
    "symptoms": {
      "en": "• **Depressed Mood**: Persistent feelings of sadness, emptiness, or hopelessness most of the day\n• **Anhedonia**: Markedly diminished interest or pleasure in almost all activities\n• Significant change in weight (>5% in a month) or appetite (decrease or increase)\n• Insomnia (difficulty sleeping) or Hypersomnia (oversleeping) nearly every day\n• Psychomotor agitation or retardation visible to others (slowing down or pacing)\n• Fatigue or profound loss of energy nearly every day\n• Feelings of **worthlessness** or excessive, inappropriate **guilt**\n• Diminished ability to think, concentrate, or make decisions\n• Recurrent **thoughts of death** or suicidal ideation (with or without a specific plan)",
      "id": "• **Suasana Perasaan Depresi**: Perasaan sedih, kosong, atau putus asa yang menetap hampir sepanjang hari\n• **Anhedonia**: Penurunan minat atau kesenangan yang nyata dalam hampir semua aktivitas\n• Perubahan berat badan yang signifikan (>5% dalam sebulan) atau nafsu makan (menurun atau meningkat)\n• Insomnia (kesulitan tidur) atau Hipersomnia (tidur berlebihan) hampir setiap hari\n• Agitasi atau retardasi psikomotor yang terlihat oleh orang lain (melambat atau gelisah secara fisik)\n• Kelelahan atau kehilangan energi yang mendalam hampir setiap hari\n• Perasaan **tidak berharga** atau rasa **bersalah** yang berlebihan dan tidak tepat\n• Penurunan kemampuan berpikir, berkonsentrasi, atau membuat keputusan\n• Pikiran **berulang tentang kematian** atau ide bunuh diri (dengan atau tanpa rencana spesifik)"
    },
    "physicalExamination": {
      "en": "• **Mental Status Examination (MSE)**: Assess for flat/restricted affect, tearfulness, delayed response latency (psychomotor slowing), poor eye contact, slouched posture, and quiet, monotonous speech. Screen for congruent delusions (e.g., delusions of ruin or somatic decay)\n• **Complete Physical Exam**: Inspect for signs of self-neglect, dry skin/brittle hair (rule out hypothyroidism), or self-inflicted cuts/scars (self-harm)\n• **Neurological Exam**: Evaluate for cognitive slowing and rule out organic diseases",
      "id": "• **Pemeriksaan Status Mental (MSE)**: Nilai afek datar/terbatas, kecenderungan menangis, keterlambatan respons bicara (perlambatan psikomotor), kontak mata buruk, postur membungkuk, dan bicara pelan serta monoton. Skrining waham yang kongruen dengan afek (misal: waham kehancuran atau kemiskinan)\n• **Pemeriksaan Fisik Lengkap**: Inspeksi tanda-tanda penelantaran diri, kulit kering/rambut rapuh (singkirkan hipotiroidisme), atau luka/bekas luka sayatan akibat melukai diri sendiri\n• **Pemeriksaan Neurologis**: Evaluasi perlambatan kognitif dan singkirkan penyakit otak organik"
    },
    "labFindings": {
      "en": "• **Diagnostic Screening Scales (Gold Standard)**: \n  • **PHQ-9 (Patient Health Questionnaire)**: 9-item tool highly validated for screening, diagnosing, and measuring severity (mild, moderate, severe) and tracking treatment response\n  • **Hamilton Depression Rating Scale (HAM-D)**: Clinician-rated severity tracker\n• **Laboratory Workup (Rule out medical mimics)**: \n  • TSH and free T4 (crucial to rule out hypothyroidism)\n  • Vitamin B12 and Vitamin D levels (deficiencies can mimic depressive symptoms)\n  • Complete Blood Count (CBC) and basic metabolic panel (electrolytes, renal, liver)",
      "id": "• **Skala Skrining Diagnostik (Gold Standard)**:\n  • **PHQ-9 (Patient Health Questionnaire)**: Alat 9-pertanyaan yang sangat tervalidasi untuk skrining, diagnosis, dan pengukuran tingkat keparahan (ringan, sedang, berat) serta pemantauan respons pengobatan\n  • **Hamilton Depression Rating Scale (HAM-D)**: Pelacak tingkat keparahan yang dinilai oleh klinisi\n• **Pemeriksaan Laboratorium (Singkirkan peniru medis)**:\n  • TSH dan T4 bebas (sangat krusial untuk menyingkirkan hipotiroidisme)\n  • Kadar Vitamin B12 dan Vitamin D (defisiensi dapat meniru gejala depresi)\n  • Darah Lengkap (CBC) dan panel metabolik dasar (elektrolit, ginjal, hati)"
    },
    "differentialDiagnosis": {
      "en": "• Bipolar Disorder (mandatory to screen for history of hypomania or mania before starting antidepressants to avoid triggering a **manic switch**)\n• Generalized Anxiety Disorder\n• Hypothyroidism\n• Adjustment Disorder with Depressed Mood (precipitated by an identifiable stressor, does not meet full MDD criteria)\n• Persistent Depressive Disorder (Dysthymia - chronic low-grade depression for >=2 years)\n• Normal Bereavement / Grief",
      "id": "• Gangguan Bipolar (wajib diskrining untuk riwayat hipomania atau mania sebelum memulai antidepresan untuk menghindari memicu **manik switch** / fase manik)\n• Gangguan Kecemasan Menyeluruh\n• Hipotiroidisme\n• Gangguan Penyesuaian dengan Afek Depresi (dipicu oleh stresor yang jelas, tidak memenuhi kriteria lengkap MDD)\n• Gangguan Depresi Persisten (Distimia - depresi derajat ringan-sedang kronis selama >=2 tahun)\n• Reaksi Berduka Normal / Grief"
    },
    "dangerSigns": {
      "en": "• **Active Suicidal Ideation**: Stated plan, intent, or access to lethal means\n• **Self-Neglect**: Complete refusal to eat, drink, or perform basic hygiene, posing an immediate physical threat to life\n• **Psychotic Features**: Hallucinations or delusions congruent with depressed mood (e.g., nihilistic beliefs that they do not exist or are decaying)\n• **Serotonin Syndrome**: Hyperreflexia, clonus, hyperthermia, autonomic instability, and altered mental status (risk when combining SSRIs with other serotonergic drugs)",
      "id": "• **Ide Bunuh Diri Aktif**: Adanya rencana, niat, atau akses ke sarana mematikan\n• **Penelantaran Diri Berat**: Penolakan total untuk makan, minum, atau menjaga kebersihan dasar, yang menimbulkan ancaman fisik langsung terhadap kelangsungan hidup\n• **Fitur Psikotik**: Halusinasi atau waham yang kongruen dengan suasana perasaan depresi (misal: keyakinan nihilistik bahwa mereka tidak ada atau tubuhnya membusuk)\n• **Sindrom Serotonin**: Hiperrefleksia, klonus, hipertermia, instabilitas otonom, dan perubahan status mental (risiko saat menggabungkan SSRI dengan obat serotonergik lainnya)"
    },
    "management": {
      "initialTreatment": {
        "en": "• **Safety Assessment (CRITICAL)**: Screen all patients for suicide risk. Ask directly about suicidal thoughts, plans, and intent. If active risk exists, implement immediate safety precautions\n• **Psychoeducation**: Educate the patient and family on the biological basis of depression, sleep hygiene, and the expected timeline of medication efficacy\n• **Psychotherapy (First-Line for Mild-to-Moderate MDD)**: Initiate **Cognitive Behavioral Therapy (CBT)** or **Interpersonal Psychotherapy (IPT)**",
        "id": "• **Penilaian Keselamatan (SANGAT KRITIS)**: Skrining semua pasien untuk risiko bunuh diri. Tanyakan langsung tentang pikiran, rencana, dan niat bunuh diri. Jika ada risiko aktif, terapkan tindakan keselamatan segera\n• **Psikoedukasi**: Edukasi pasien dan keluarga mengenai dasar biologis depresi, kebersihan tidur, dan lini waktu efektivitas obat yang diharapkan\n• **Psikoterapi (Lini Pertama untuk MDD Ringan-Sedang)**: Mulai **Terapi Perilaku Kognitif (CBT)** atau **Psikoterapi Interpersonal (IPT)**"
      },
      "definitiveTreatment": {
        "en": "• **Pharmacotherapy (First-Line for Moderate-to-Severe MDD)**:\n  • **Selective Serotonin Reuptake Inhibitors (SSRIs)**: Preferred due to safety profile:\n    • **Sertraline**: Start **50 mg PO daily**, titrate weekly to target **100-200 mg PO daily**\n    • **Escitalopram**: Start **10 mg PO daily**, titrate to target **20 mg PO daily**\n    • **Fluoxetine**: Start **20 mg PO daily** (long half-life, useful for non-compliant patients)\n  • **Counseling on Onset**: Advise that clinical response takes **2-4 weeks** to begin, and full effect requires **6-8 weeks**. Explain that antidepressant therapy must continue for at least **6-9 months** after full remission to prevent relapse\n• **Electroconvulsive Therapy (ECT)**: Highly effective and indicated for severe treatment-resistant depression, psychotic depression, or life-threatening self-neglect",
        "id": "• **Farmakoterapi (Lini Pertama untuk MDD Sedang-Berat)**:\n  • **Selective Serotonin Reuptake Inhibitor (SSRI)**: Pilihan utama karena profil keamanan:\n    • **Sertralin**: Mulai **50 mg PO sehari**, titrasi mingguan ke target **100-200 mg PO sehari**\n    • **Esitalopram**: Mulai **10 mg PO sehari**, titrasi ke target **20 mg PO sehari**\n    • **Fluoksetin**: Mulai **20 mg PO sehari** (waktu paruh panjang, berguna untuk pasien tidak patuh)\n  • **Konseling Mengenai Efek**: Jelaskan bahwa respons klinis membutuhkan waktu **2-4 minggu** untuk mulai terasa, dan efek penuh membutuhkan **6-8 minggu**. Jelaskan bahwa terapi antidepresan harus dilanjutkan minimal **6-9 bulan** setelah remisi penuh untuk mencegah kambuh\n• **Terapi Elektrokonvulsif (ECT)**: Sangat efektif dan diindikasikan untuk depresi berat yang resisten terhadap obat, depresi psikotik, atau penelantaran diri yang mengancam jiwa"
      },
      "rehab": {
        "en": "• Behavioral activation protocols (schedule positive reinforcement activities daily)\n• Support groups and return-to-work occupational therapy plans",
        "id": "• Protokol aktivasi perilaku (jadwalkan aktivitas penguatan positif setiap hari)\n• Kelompok pendukung (support groups) dan rencana terapi okupasi untuk kembali bekerja"
      },
      "referral": {
        "en": "• **Refer urgently to Psychiatry / Inpatient Unit** for:\n  • Active suicidal plan, intent, or history of recent suicide attempt\n  • Severe self-neglect or psychotic features\n  • Treatment-resistant depression failing >=2 adequate trials of different antidepressants\n  • Suspected bipolar depression (requires mood stabilizers to prevent manic switch)",
        "id": "• **Rujuk segera ke Psikiatri / Rawat Inap Psikiatri** untuk:\n  • Rencana atau niat bunuh diri aktif, atau riwayat percobaan bunuh diri baru-baru ini\n  • Penelantaran diri yang parah atau fitur psikotik\n  • Depresi resisten pengobatan yang gagal dalam >=2 uji coba adekuat antidepresan yang berbeda\n  • Dugaan depresi bipolar (memerlukan mood stabilizer untuk mencegah manic switch)"
      },
      "workup": {
        "en": "• Perform suicide screening, conduct baseline PHQ-9, check complete laboratory panels to rule out mimics, and establish clear functional monitoring parameters",
        "id": "• Lakukan skrining bunuh diri, lakukan PHQ-9 baseline, periksa laboratorium lengkap untuk menyingkirkan peniru, dan tetapkan parameter pemantauan fungsional yang jelas"
      }
    },
    "followUp": {
      "en": "• Review the patient every **1-2 weeks** after starting or adjusting antidepressants to monitor for increased **suicidal ideation** (critical risk in young adults under 25 during initial weeks) and side effects (nausea, headache, sexual dysfunction)\n• Utilize the **PHQ-9** at each visit to objectively track symptom reduction",
      "id": "• Tinjau pasien setiap **1-2 minggu** setelah memulai atau menyesuaikan antidepresan untuk memantau peningkatan **ide bunuh diri** (risiko kritis pada dewasa muda <25 tahun selama minggu-minggu awal) dan efek samping (mual, sakit kepala, disfungsi seksual)\n• Gunakan **PHQ-9** pada setiap kunjungan untuk melacak pengurangan gejala secara objektif"
    },
    "prevention": {
      "pharmacological": {
        "en": "• Continue maintenance therapy for **6-9 months** post-remission for a first episode, and **2 years or indefinitely** for recurrent depression to prevent relapse",
        "id": "• Lanjutkan terapi pemeliharaan selama **6-9 bulan** pasca-remisi untuk episode pertama, dan **2 tahun atau selamanya** untuk depresi berulang guna mencegah kekambuhan"
      },
      "nonPharmacological": {
        "en": "• Regular aerobic exercise (increases BDNF and endorphins)\n• Structured stress management training, mindfulness-based cognitive therapy (MBCT), and cultivating a robust social support network",
        "id": "• Olahraga aerobik teratur (meningkatkan BDNF dan endorfin)\n• Pelatihan manajemen stres terstruktur, terapi kognitif berbasis kesadaran (MBCT), dan membangun jaringan dukungan sosial yang kuat"
      }
    },
    "caseExample": {
      "en": "A 32-year-old female presents with a 3-week history of persistent sad mood, daily insomnia, severe fatigue, feelings of worthlessness, and a lack of interest in her hobbies. She reports no history of hypomania or mania. She has no active suicide plan but reports vague passive thoughts of wishing she would not wake up. Her PHQ-9 score is 18, indicating severe depression. Physical exam and laboratory screens (TSH, Vitamin B12, electrolytes) are completely normal. She is diagnosed with Major Depressive Disorder (Moderate-to-Severe, Single Episode) and started on **Sertraline 50 mg PO daily**, combined with a referral for **Cognitive Behavioral Therapy (CBT)**. She is counselled on the delayed onset of antidepressants. At a 2-week follow-up, she reports mild transient nausea but no increase in suicidal thoughts. By week 6, her Sertraline has been titrated to 100 mg daily, she has attended 4 CBT sessions, her sleep has normalized, and her PHQ-9 score decreases to 6 (remission), with zero active or passive suicidal thoughts.",
      "id": "Seorang wanita berusia 32 tahun datang dengan riwayat suasana perasaan sedih yang menetap sejak 3 minggu, insomnia harian, kelelahan hebat, perasaan tidak berharga, dan hilangnya minat pada hobinya. Ia melaporkan tidak ada riwayat hipomania atau mania. Ia tidak memiliki rencana bunuh diri aktif tetapi melaporkan pikiran pasif yang samar berharap ia tidak bangun lagi. Skor PHQ-9 miliknya adalah 18, menunjukkan depresi berat. Pemeriksaan fisik dan laboratorium (TSH, Vitamin B12, elektrolit) benar-benar normal. Ia didiagnosis dengan Gangguan Depresi Mayor (Sedang-Berat, Episode Tunggal) dan mulai diberikan **Sertralin 50 mg PO sehari**, dikombinasikan dengan rujukan untuk **Terapi Perilaku Kognitif (CBT)**. Ia diberikan konseling tentang efek tertunda antidepresan. Pada kontrol 2 minggu, ia melaporkan mual ringan sementara tetapi tidak ada peningkatan pikiran bunuh diri. Pada minggu ke-6, dosis Sertralin telah dititrasi menjadi 100 mg sehari, ia telah mengikuti 4 sesi CBT, tidurnya telah normal, dan skor PHQ-9-nya turun menjadi 6 (remisi), tanpa pikiran bunuh diri aktif maupun pasif."
    },
    "references": {
      "en": "• APA Practice Guideline for the Treatment of Patients with Major Depressive Disorder, 3rd Edition (American Psychiatric Association 2010)\n• CANMAT 2016 Clinical Guidelines for the Management of Adults with Major Depressive Disorder (Canadian Network for Mood and Anxiety Treatments)\n• Gelenberg AJ, et al. Am J Psychiatry. 2010;167(10):1-118\n• Kennedy SH, et al. Can J Psychiatry. 2016;61(9):540-560",
      "id": "• Pedoman Praktik APA untuk Pengobatan Pasien dengan Gangguan Depresi Mayor, Edisi ke-3 (American Psychiatric Association 2010)\n• Pedoman Klinis CANMAT 2016 untuk Penatalaksanaan Orang Dewasa dengan Gangguan Depresi Mayor (Jaringan Kanada untuk Perawatan Suasana Hati dan Kecemasan)\n• Gelenberg AJ, et al. Am J Psychiatry. 2010;167(10):1-118\n• Kennedy SH, et al. Can J Psychiatry. 2016;61(9):540-560"
    },
    "id": 34,
    "content": {
      "en": "Major Depressive Disorder (MDD) is a common, highly disabling psychiatric disorder characterized by **>=2 weeks** of persistent **depressed mood** or **anhedonia** (loss of interest or pleasure), accompanied by at least 4 additional somatic or cognitive symptoms (changes in sleep, appetite, energy, self-valuation, psychomotor activity, concentration, or suicidal thoughts), diagnosed using the **DSM-5-TR criteria**.",
